...
git clone https://github.com/ivanierruk/movilidadForanea.git
cd movilidadForanea
...
**Regional-scale kernel density of hotels in selected cities in Mexico**
...
> **Note:** To view other maps, navigate to `post-processing/hotels/local_kernel.jpg` or `post-processing/hotels/regional_kernel.jpg`.
