...
*(This map visualizes the Origin-Destination matrix, scaling the connections based on trip availability between the selected cities).*

![Interurban Travel Flows](post-processing/mobility/flow_cities.jpg)
